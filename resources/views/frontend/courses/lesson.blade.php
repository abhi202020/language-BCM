                                                ...
                                                <div class="panel position-relative">
                                                    ...
                                                    <div id="collapse{{$count}}" class="collapse" aria-labelledby="headingOne"
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <p class="my-auto"><span class="font-weight-bold">@lang('labels.frontend.course.live_lesson_meeting_date')</span> : {{ $lessonSlot->start_at->format('Y-m-d\TH:i') }} <strong>({{ config('zoom.timezone') }})</strong></p>
