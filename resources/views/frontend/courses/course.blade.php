                                ...
                                <h3><a href="{{ route('courses.show', [$course->slug]) }}"><b>{{$course->title}}</b></a>
                                    @if($course->trending == 1)
                                        <span class="trend-badge text-uppercase bold-font">
                                            <i class="fas fa-bolt"></i> @lang('labels.frontend.badges.trending')
                                        </span>
                                    @endif
                                </h3>
                            </div>
                                                ...
                                                <div id="collapse{{$count}}" class="collapse" aria-labelledby="headingOne"
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        @if($lesson->model->live_lesson)
                                                            ...
                                                            <form class="card live-lesson-slot-form" action="{{ route('book.slot', ['slotId' => $slot->id]) }}" method="post">
                                                                @csrf
                                                                <div class="card-body" onclick="this.closest('form').submit();">
                                                                    @lang('labels.frontend.course.date') {{ $slot->start_at }}
                                                                    <span class="slot-status" style="color: {{ !$slot->isFullyBooked() ? 'green' : 'red' }}">
                                                                        {{ !$slot->isFullyBooked() ? 'Slot Available - Click to Book' : 'Slot Fully Booked' }}
                                                                    </span>
                                                                </div>
                                                            </form>
                    ...
                    <div class="side-bar">
                        ...
                        <div class="couse-feature ul-li-block">
                            <ul>
                                ...
                                <li class="d-inline-block w-100">@lang('labels.frontend.course.category')
