...
<!DOCTYPE html>
@langrtl <html lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="rtl">
...
<body class="{{ config('layout_type') }}">
    ...
    <div id="app">
                                    ...
                                    <ul>
                                        ...
                                        @if (auth()->check())
                                            ...
                                            @if ($logged_in_user->hasRole('student'))
                                                <li>
                                                    <a href="{{ route('admin.dashboard') }}">@lang('My Dashboard')</a>
                                                </li>
                                                <li>
        ...
        @yield('content') <!-- import homepage content - resources/views/frontend/index-1.blade.php -->
        @include('cookieConsent::index') <!-- cookie use notification -->
        @include('frontend.layouts.partials.footer') <!-- import footer blade - resources/views/frontend/layouts/partials/footer.blade.php -->
