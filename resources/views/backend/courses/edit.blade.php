...
@section('content')
                ...
                <div class="col-12 col-lg-4 form-group">
                    ...
                    @if ($course->course_image)
                        <a href="{{ asset('storage/uploads/'.$course->course_image) }}" target="_blank">
                            <img height="50px" src="{{ asset('storage/uploads/'.$course->course_image) }}" class="mt-1">
                        </a>
                    @endif
                </div>
               <div class="col-12 col-lg-4 form-group">
    {!! Form::label('start_date', trans('labels.backend.courses.fields.start_date').' ('.trans('labels.backend.courses.fields.date_format').')', ['class' => 'control-label']) !!}
    ...
    @endif
              ...
              @if (Auth::user()->isAdmin())
    <div class="col-12 col-lg-4 form-group">
        {!! Form::label('expire_at', trans('labels.backend.courses.fields.expire_at').' ('.trans('labels.backend.courses.fields.date_format').')', ['class' => 'control-label']) !!}
