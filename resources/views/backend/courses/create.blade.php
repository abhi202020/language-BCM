    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4  form-group">
                    {!! Form::label('start_date', trans('labels.backend.courses.fields.start_date').' (Y-m-d\TH:i)', ['class' => 'control-label']) !!}
                ...
                @if (Auth::user()->isAdmin())
                <div class="col-12 col-lg-4  form-group">
                    {!! Form::label('expire_at', trans('labels.backend.courses.fields.expire_at').' (Y-m-d\TH:i)', ['class' => 'control-label']) !!}
