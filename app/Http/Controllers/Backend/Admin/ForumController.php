...
class ForumController extends Controller {
    ...
    public function show($id) {
        // Fetch the forum post using the Post model
        $forumPost = Post::findOrFail($id);

        // Fetch the categories for the dropdown
        $categories = Category::orderBy('created_at', 'desc')->get()->pluck('name', 'id')->prepend('Please select', '');

        return view('your.view.name', compact('forumPost', 'categories'));
    }
