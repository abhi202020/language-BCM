...
<?php $__env->startSection('content'); ?>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-12 form-group">
                    ...
                    <?php echo Form::textarea('description', old('description'), ['class' => 'form-control editor', 'placeholder' => trans('labels.backend.courses.fields.description')]); ?>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4 form-group">
                    ...
                    <?php if($course->course_image): ?>
                        <a href="<?php echo e(asset('storage/uploads/'.$course->course_image)); ?>" target="_blank">
                            <img height="50px" src="<?php echo e(asset('storage/uploads/'.$course->course_image)); ?>" class="mt-1">
                        </a>
                    <?php endif; ?>
                </div>
               <div class="col-12 col-lg-4 form-group">
    <?php echo Form::label('start_date', trans('labels.backend.courses.fields.start_date').' ('.trans('labels.backend.courses.fields.date_format').')', ['class' => 'control-label']); ?>

    <?php echo Form::text('start_date', old('start_date'), [
        'class' => 'form-control date',
        'pattern' => '(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))',
        'placeholder' => trans('labels.backend.courses.fields.start_date_placeholder').' (Ex. 2019-01-01)'
    ]); ?>
    ...
    <?php endif; ?>
              ...
              <?php if(Auth::user()->isAdmin()): ?>
    <div class="col-12 col-lg-4 form-group">
        <?php echo Form::label('expire_at', trans('labels.backend.courses.fields.expire_at').' ('.trans('labels.backend.courses.fields.date_format').')', ['class' => 'control-label']); ?>

        <?php echo Form::text('expire_at', old('expire_at'), [
            'class' => 'form-control date',
            'pattern' => '(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))',
            'placeholder' => trans('labels.backend.courses.fields.expire_at_placeholder').' (Ex. 2019-01-01)',
            'autocomplete' => 'off'
        ]); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\language\resources\views\backend\courses\edit.blade.php ENDPATH**/ ?>