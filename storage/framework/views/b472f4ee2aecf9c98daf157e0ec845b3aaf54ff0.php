<!-- resources/views/frontend/layouts/app1.blade.php -->

<!DOCTYPE html>
<?php if (\Illuminate\Support\Facades\Blade::check('langrtl')): ?> <html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" dir="rtl">
...
<head>
    ...
    <!-- colors - public/assets/css/colors -->
    <link href="<?php echo e(asset('assets/css/colors/color-2.css')); ?>" rel="alternate stylesheet" type="text/css" title="color-2">
    <link href="<?php echo e(asset('assets/css/colors/color-3.css')); ?>" rel="alternate stylesheet" type="text/css" title="color-3">
    <link href="<?php echo e(asset('assets/css/colors/color-4.css')); ?>" rel="alternate stylesheet" type="text/css" title="color-4">
    <link href="<?php echo e(asset('assets/css/colors/color-5.css')); ?>" rel="alternate stylesheet" type="text/css" title="color-5">
    <link href="<?php echo e(asset('assets/css/colors/color-6.css')); ?>" rel="alternate stylesheet" type="text/css" title="color-6">
    <link href="<?php echo e(asset('assets/css/colors/color-7.css')); ?>" rel="alternate stylesheet" type="text/css" title="color-7">
    <link href="<?php echo e(asset('assets/css/colors/color-8.css')); ?>" rel="alternate stylesheet" type="text/css" title="color-8">
    <link href="<?php echo e(asset('assets/css/colors/color-9.css')); ?>" rel="alternate stylesheet" type="text/css" title="color-9">

    <!-- extras? public/vendor/unisharp/laravel-ckeditor etc..  -->
...
<body class="<?php echo e(config('layout_type')); ?>">
    ...
    <div id="app">
        <!-- login modal - resources/views/frontend/layouts/modals/loginModal.blade.php -->
                    ...
                    <div class="container">
                        <div class="navbar-default">
                            ...
                            <div class="cart-search float-right ul-li">
                                <ul>
                                    <li>
                                        <a href="<?php echo e(route('cart.index')); ?>"><i class="fa fa-shopping-cart"></i>
                                    ...
                                    <ul>
                                                        ...
                                                        <li class="menu-item-has-children ul-li-block">
                                                            ...
                                                            <ul class="sub-menu">
                                                                <?php $__currentLoopData = $menu->subs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <?php echo $__env->make(
                                                                        'frontend.layouts.partials.dropdown',
                                                                        $item
                                        ...
                                        <?php if(auth()->check()): ?>
                                            ...
                                            <?php if($logged_in_user->hasRole('student')): ?>
                                                <li>
                                                    <a href="<?php echo e(route('admin.dashboard')); ?>"><?php echo app('translator')->get('My Dashboard'); ?></a>
                                                </li>
                                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <?php if(auth()->check()): ?>
                                            <li class="">
                                                ...
                                                <ul class="">
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view backend')): ?>
                                                        <li><a href="<?php echo e(route('admin.dashboard')); ?>"><?php echo app('translator')->get('navs.frontend.dashboard'); ?></a></li>
                                                    <?php endif; ?>
                                                    <li> <a href="<?php echo e(route('frontend.auth.logout')); ?>"><?php echo app('translator')->get('navs.general.logout'); ?></a></li>
                                                </ul>
                                            </li>
                                        <?php else: ?>
                                            <li>
        ...
        <?php echo $__env->yieldContent('content'); ?> <!-- import homepage content - resources/views/frontend/index-1.blade.php -->
        <?php echo $__env->make('cookieConsent::index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <!-- cookie use notification -->
        <?php echo $__env->make('frontend.layouts.partials.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <!-- import footer blade - resources/views/frontend/layouts/partials/footer.blade.php -->
    ...
    <?php if(!empty(config('custom_js'))): ?>
        <script><?php echo config('custom_js'); ?></script>
    <?php endif; ?>

</body>
</html>
<?php /**PATH /home/customer/www/uat.margiesmagicalverbs.com/public_html/resources/views/frontend/layouts/app1.blade.php ENDPATH**/ ?>