        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-4 form-group">
                    <?php echo Form::label('passing_score',trans('labels.backend.tests.fields.score_field'), ['class' => 'control-label']); ?>

                    <?php echo Form::text('passing_score', old('passing_score'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.tests.fields.score_field_placeholder')]); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\language\resources\views\backend\tests\create.blade.php ENDPATH**/ ?>