        ...
        <div class="container">
            <div class="page-breadcrumb-content text-center">
                <div class="page-breadcrumb-title">
                    <h2 class="breadcrumb-head black bold">"<?php echo e($q); ?>" <span><?php echo app('translator')->get('labels.frontend.search_result.blog'); ?></span></h2>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="blog-post-img-content">
                                                            <div class="blog-img-date relative-position">
                                                                <div class="blog-thumnile" style="background-image: url(<?php echo e(asset('storage/uploads/'.$item->image)); ?>)">
                                                            ...
                                                            <div class="blog-title-content headline">
                                                                ...
                                                                <div class="blog-content">
                                                                    <?php echo mb_substr($item->content,0,100).'...'; ?>

                                                                </div>

                                                                <div class="view-all-btn bold-font">
                                                                    <a href="<?php echo e(route('blogs.index',['slug'=> $item->slug.'-'.$item->id])); ?>">Read More <i
...
<?php echo $__env->make('frontend.layouts.app'.config('theme_layout'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\language\resources\views\frontend\search-result\blogs.blade.php ENDPATH**/ ?>