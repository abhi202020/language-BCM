...
<?php $__env->startSection('content'); ?>
    <?php echo Form::model($blog, ['method' => 'PUT', 'route' => ['admin.blogs.update', $blog->id], 'files' => true,]); ?>


    <div class="card">
        <div class="card-header">
            <h3 class="page-title float-left mb-0"><?php echo app('translator')->get('labels.backend.blogs.edit'); ?></h3>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-12 col-lg-6 form-group">
                    ...
                    <?php echo Form::select('category', $category,  $blog->category_id, ['class' => 'form-control select2']); ?>
            ...
            <div class="row">
                <div class="col-12 col-lg-6 form-group">
                    ...
                    <?php echo Form::text('slug', old('slug'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.blogs.slug_placeholder')]); ?>
                ...
                <?php if($blog->image): ?>
                    ...
                    <div class="col-lg-1 col-12 form-group">
                        <a href="<?php echo e(asset('storage/uploads/'.$blog->image)); ?>" target="_blank"><img
                                    src="<?php echo e(asset('storage/uploads/'.$blog->image)); ?>" height="65px"
                                    width="65px"></a>
                    </div>
                <?php else: ?>
                    <div class="col-12 col-lg-6 form-group">
            ...
            <div class="row">
                <div class="col-md-12 form-group">
                    <?php echo Form::text('tags', $tags, ['class' => 'form-control','data-role' => 'tagsinput', 'placeholder' => trans('labels.backend.blogs.fields.tags_placeholder'),'id'=>'tags']); ?>
            ...
            <div class="col-md-12 text-center form-group">
                    ...
                    <a href="<?php echo e(route('admin.blogs.index')); ?>" class="btn btn-danger waves-effect waves-light ">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\language\resources\views\backend\blogs\edit.blade.php ENDPATH**/ ?>