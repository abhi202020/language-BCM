    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4 form-group">
                    <?php echo Form::label('start_date', trans('labels.backend.bundles.fields.start_date').' (Y-m-d\TH:i)', ['class' => 'control-label']); ?>
                ...
                <div class="col-12 col-lg-4 form-group">
                    <?php echo Form::label('expire_at', trans('labels.backend.bundles.fields.expire_at').' (Y-m-d\TH:i)', ['class' => 'control-label']); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\language\resources\views/backend/bundles/edit.blade.php ENDPATH**/ ?>