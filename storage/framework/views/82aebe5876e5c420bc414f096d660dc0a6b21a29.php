                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="header-top-text">
                                    <span>Welcome to <?php echo e(env('APP_NAME')); ?></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="navbar-default">
                            <div class="navbar-header float-left">
                                <a class="navbar-brand text-uppercase" href="<?php echo e(url('/')); ?>"><img
                                            src="<?php echo e(asset("storage/logos/".config('logo_b_image'))); ?>" alt="logo"></a>
                            </div><!-- /.navbar-header -->
                            ...
                            <div class="mobile-menu">
                                <div class="logo"><a href="<?php echo e(url('/')); ?>"><img
                                                src="<?php echo e(asset('assets/img/logo/logo.png')); ?>" alt="Logo"></a></div>
                                <nav>
                                    <ul>
                                        <?php if(count($custom_menus) > 0 ): ?>
                                            <?php $__currentLoopData = $custom_menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php if(auth()->check()): ?>
                                            <li class="">
                                                <a class="text-dark" href="#!"><?php echo e($logged_in_user->name); ?></a>
                                                <ul>
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view backend')): ?>
                                                        <li>
                                                            <a href="<?php echo e(route('admin.dashboard')); ?>"><?php echo app('translator')->get('navs.frontend.dashboard'); ?></a>
...
<?php /**PATH C:\xampp\htdocs\language\resources\views\frontend\layouts\app3.blade.php ENDPATH**/ ?>