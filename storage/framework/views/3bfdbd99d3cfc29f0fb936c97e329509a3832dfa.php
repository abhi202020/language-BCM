...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <a href="<?php echo e(route('admin.bundles.index')); ?>" class="btn btn-primary float-right"><?php echo app('translator')->get('labels.general.back'); ?></a>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            <th><?php echo app('translator')->get('labels.backend.bundles.fields.slug'); ?></th>
                        ...
                        <tr>
                            <th><?php echo app('translator')->get('labels.backend.bundles.fields.description'); ?></th>
                            <td><?php echo $bundle->description; ?></td>
                        </tr>
                        <tr>
                            <th><?php echo app('translator')->get('labels.backend.bundles.fields.price'); ?></th>
                            <td><?php echo e(($bundle->free == 1) ? trans('labels.backend.bundles.fields.free') : $bundle->price .' '.$appCurrency['symbol']); ?></td>
                        </tr>
                        <tr>
                            <th><?php echo app('translator')->get('labels.backend.bundles.fields.course_image'); ?></th>
                        ...
                        <tr>
                            <th><?php echo app('translator')->get('labels.backend.bundles.fields.start_date'); ?></th>
                            <td><?php echo e($bundle->start_date); ?></td>
                        </tr>
                        <tr>
                            <th><?php echo app('translator')->get('labels.backend.bundles.fields.expire_at'); ?></th>
                            <td><?php echo e($bundle->expire_at); ?></td>
                        </tr>
                        <tr>
                            <th><?php echo app('translator')->get('labels.backend.bundles.fields.published'); ?></th>
                            <td><?php echo e(Form::checkbox("published", 1, $bundle->published == 1 ? true : false, ["disabled"])); ?></td>
                        </tr>
                        <tr>
                            <th><?php echo app('translator')->get('labels.backend.bundles.fields.meta_title'); ?></th>
                            <td><?php echo e($bundle->meta_title); ?></td>
                        </tr>
                        <tr>
                            <th><?php echo app('translator')->get('labels.backend.bundles.fields.meta_description'); ?></th>
                            <td><?php echo e($bundle->meta_description); ?></td>
                        </tr>
                        <tr>
                            <th><?php echo app('translator')->get('labels.backend.bundles.fields.meta_keywords'); ?></th>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\language\resources\views/backend/bundles/show.blade.php ENDPATH**/ ?>