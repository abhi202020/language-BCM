                                ...
                                <h3><a href="<?php echo e(route('courses.show', [$course->slug])); ?>"><b><?php echo e($course->title); ?></b></a>
                                    <?php if($course->trending == 1): ?>
                                        <span class="trend-badge text-uppercase bold-font">
                                            <i class="fas fa-bolt"></i> <?php echo app('translator')->get('labels.frontend.badges.trending'); ?>
                                        </span>
                                    <?php endif; ?>
                                </h3>
                            </div>
                                    ...
                                    <?php $__currentLoopData = $lessons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $lesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($lesson->model && $lesson->model->published == 1): ?>
                                            ...
                                            <div class="panel position-relative">
                                                <?php if(auth()->check()): ?>
                                                    <?php if(in_array($lesson->model->id,$completed_lessons)): ?>
                                                        <div class="position-absolute" style="right: 0;top:0px">
                                                            <span class="gradient-bg p-1 text-white font-weight-bold completed"><?php echo app('translator')->get('labels.frontend.course.completed'); ?></span>
                                                        </div>
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                                    ...
                                                    <div class="ac-head">
                                                        ...
                                                        <?php if($lesson->model->live_lesson): ?>
                                                            <div class="leanth-course">
                                                                <span><?php echo app('translator')->get('labels.frontend.course.live_lesson'); ?></span>
                                                            </div>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                                <div id="collapse<?php echo e($count); ?>" class="collapse" aria-labelledby="headingOne"
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <?php if($lesson->model->live_lesson): ?>
                                                            ...
                                                            <form class="card live-lesson-slot-form" action="<?php echo e(route('book.slot', ['slotId' => $slot->id])); ?>" method="post">
                                                                <?php echo csrf_field(); ?>
                                                                <div class="card-body" onclick="this.closest('form').submit();">
                                                                    <?php echo app('translator')->get('labels.frontend.course.date'); ?> <?php echo e($slot->start_at); ?>

                                                                    <span class="slot-status" style="color: <?php echo e(!$slot->isFullyBooked() ? 'green' : 'red'); ?>">
                                                                        <?php echo e(!$slot->isFullyBooked() ? 'Slot Available - Click to Book' : 'Slot Fully Booked'); ?>
                                                            ...
                                                            <?php if(in_array($lesson->model->id,$completed_lessons)): ?>
                                                                <div>
                                                                    <a class="btn btn-warning mt-3"
                                                                       href="<?php echo e(route('lessons.show',['course_id' => $lesson->course->id,'slug'=>$lesson->model->slug])); ?>">
                ...
                <div class="col-md-3">
                    <div class="side-bar">
                        <div class="course-side-bar-widget">
                            ...
                            ?>
                            <?php if($courseExpire==false && !$purchased_course && $matched['matched']==false && $matched['matchedBundle']==false): ?>
                                <h3>
                            ...
                            <?php else: ?>
                                ...
                                <?php if($continue_course || !empty($checkSubcribePlan)): ?>
                        ...
                        <div class="couse-feature ul-li-block">
                            <ul>
                                ...
                                <li class="d-inline-block w-100"><?php echo app('translator')->get('labels.frontend.course.category'); ?>
                                    <span class="text-right">
                                        <a href="<?php echo e(route('courses.category',['category'=>$course->category->slug])); ?>" target="_blank"><?php echo e($course->category->name); ?></a>
                                    </span>
                                </li>
...
<?php echo $__env->make('frontend.layouts.app'.config('theme_layout'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/uat.margiesmagicalverbs.com/public_html/resources/views/frontend/courses/course.blade.php ENDPATH**/ ?>