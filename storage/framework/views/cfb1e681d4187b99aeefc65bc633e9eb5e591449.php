...
<div class="in-total border-top pt-3"><?php echo app('translator')->get('labels.frontend.cart.total_payable'); ?>
    <span><?php echo e($appCurrency['symbol'].' '.number_format(Cart::session(auth()->user()->id)->getTotal(),2)); ?></span>
</div>

<div class="input-group mt-3 mb-1">
    <input type="text" id="coupon" pattern="[^\s]+" name="coupon" class="form-control" placeholder="Enter Coupon">
    <div class="input-group-append">
        <button class="btn btn-dark shadow-none " id="applyCoupon" type="button">
...
<?php /**PATH C:\xampp\htdocs\language\resources\views/frontend/cart/partials/order-stats.blade.php ENDPATH**/ ?>