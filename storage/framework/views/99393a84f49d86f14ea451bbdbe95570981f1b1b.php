...
<?php $__env->startSection('title', __('labels.backend.general_settings.contact.title').' | '.app_name()); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-sm-5">
                    <h3 class="page-title d-inline"><?php echo app('translator')->get('labels.backend.general_settings.contact.title'); ?></h3>
                </div>
            </div>
        </div>
        ...
        <div class="card-body" id="contact">
            ...
            <div class="form-group row">
                <?php echo e(html()->label(__('labels.backend.general_settings.contact.short_text'))->class('col-md-2 form-control-label')->for('short_text')); ?>
            ...
            <div class="form-group row">
                <?php echo e(html()->label(__('labels.backend.general_settings.contact.primary_address'))->class('col-md-2 form-control-label')->for('primary_address')); ?>
            ...
            <div class="form-group row">
                ...
                <?php echo e(html()->label(__('labels.backend.general_settings.contact.secondary_address'))->class('col-md-2 form-control-label')->for('secondary_address')); ?>
            ...
            <div class="form-group row">
                ...
                <?php echo e(html()->label(__('labels.backend.general_settings.contact.primary_phone'))->class('col-md-2 form-control-label')->for('primary_phone')); ?>
            ...
            <div class="form-group row">
                <?php echo e(html()->label(__('labels.backend.general_settings.contact.secondary_phone'))->class('col-md-2 form-control-label')->for('secondary_phone')); ?>
            ...
            <div class="form-group row">
                ...
                <?php echo e(html()->label(__('labels.backend.general_settings.contact.primary_email'))->class('col-md-2 form-control-label')->for('primary_email')); ?>


                <div class="col-md-8">
                    <?php echo e(html()->email('')
                    ->id('primary_email')
                        ->class('form-control')
            ...
            <div class="form-group row">
                <?php echo e(html()->label(__('labels.backend.general_settings.contact.secondary_email'))->class('col-md-2 form-control-label')->for('secondary_email')); ?>
            ...
            <div class="form-group row">
                <div class="col-6 border-right">
                    <div class="row">
                        <?php echo e(html()->label(__('labels.backend.general_settings.contact.location_on_map'))->class('col-md-12 form-control-label')->for('location_on_map')); ?>
                ...
                <div class="col-6">
                    <?php echo __('labels.backend.general_settings.contact.map_note'); ?>
...
<?php $__env->startPush('after-scripts'); ?>
    <script>
       ...
       <?php if(config('contact_data')): ?>
            var contact_data = <?php echo config('contact_data'); ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\language\resources\views/backend/settings/contact.blade.php ENDPATH**/ ?>