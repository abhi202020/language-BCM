...
<?php $__env->startSection('title', __('labels.backend.access.users.management') . ' | ' . __('labels.backend.access.users.deleted')); ?>
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    ...
                    <small class="text-muted"><?php echo app('translator')->get('labels.backend.access.users.deleted'); ?></small>
                </h4>
            </div><!--col-->
        </div><!--row-->
            ...
            <div class="col">
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <?php else: ?>
                            <tr><td colspan="9"><p class="text-center"><?php echo app('translator')->get('strings.backend.access.users.no_deleted'); ?></p></td></tr>
                        <?php endif; ?>
                        </tbody>
                    </table>
                </div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\language\resources\views\backend\auth\user\deleted.blade.php ENDPATH**/ ?>