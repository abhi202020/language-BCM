                            ...
                            <div class="about-btn text-center">
                                <?php $__currentLoopData = $content->buttons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $button): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="genius-btn gradient-bg text-center text-uppercase ul-li-block bold-font ">
                                        <a href="<?php echo e($button->link); ?>"><?php echo e($button->label); ?> <i class="fas fa-caret-right"></i></a>
                                    </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/customer/www/uat.margiesmagicalverbs.com/public_html/resources/views/frontend/layouts/partials/slider.blade.php ENDPATH**/ ?>