...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo Form::open(['method' => 'POST', 'route' => ['admin.bundles.store'], 'files' => true,]); ?>


    <div class="card">
        <div class="card-header">
            <h3 class="page-title d-inline"><?php echo app('translator')->get('labels.backend.bundles.create'); ?></h3>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-10 form-group">
                    ...
                    <?php echo Form::select('courses[]', $courses, old('courses'), ['class' => 'form-control select2 js-example-placeholder-multiple', 'multiple' => 'multiple']); ?>
            ...
            <div class="row">
                <div class="col-12 col-lg-6 form-group">
                    ...
                    <?php echo Form::text('title', old('title'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.bundles.fields.title'), 'required' => false]); ?>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4 form-group">
                    <?php echo Form::label('course_image',  trans('labels.backend.bundles.fields.course_image'), ['class' => 'control-label']); ?>
                ...
                <div class="col-12 col-lg-4  form-group">
                   <?php echo Form::label('start_date', trans('labels.backend.bundles.fields.start_date'), ['class' => 'control-label']); ?>


                    <?php echo Form::text('start_date', old('start_date'), ['class' => 'form-control date','pattern' => '(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))', 'placeholder' => trans('labels.backend.bundles.fields.start_date').' (Ex . 2019-01-01)', 'autocomplete' => 'off']); ?>


                </div>
                <?php if(Auth::user()->isAdmin()): ?>
               <div class="col-12 col-lg-4 form-group">
    <?php echo Form::label('expire_at', trans('labels.backend.bundles.fields.expire_at'), ['class' => 'control-label']); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\language\resources\views/backend/bundles/create.blade.php ENDPATH**/ ?>