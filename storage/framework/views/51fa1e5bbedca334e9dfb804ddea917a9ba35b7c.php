            ...
            <div class="page-breadcrumb-content text-center">
                <div class="page-breadcrumb-title">
                    <h2 class="breadcrumb-head black bold"><?php echo e(env('APP_NAME')); ?>
                        ...
                        <span> <?php echo app('translator')->get('labels.frontend.certificate_verification.title'); ?></span></h2>
                </div>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('frontend.layouts.app'.config('theme_layout'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\language\resources\views\frontend\certificate-verification.blade.php ENDPATH**/ ?>