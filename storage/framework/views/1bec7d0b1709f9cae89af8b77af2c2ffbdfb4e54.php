                                                ...
                                                <div class="panel position-relative">
                                                    ...
                                                    <div id="collapse<?php echo e($count); ?>" class="collapse" aria-labelledby="headingOne"
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <p class="my-auto"><span class="font-weight-bold"><?php echo app('translator')->get('labels.frontend.course.live_lesson_meeting_date'); ?></span> : <?php echo e($lessonSlot->start_at->format('Y-m-d\TH:i')); ?> <strong>(<?php echo e(config('zoom.timezone')); ?>)</strong></p>
...
<?php $__env->startPush('after-scripts'); ?>
    <script>
        <?php if($lesson->mediaVideo && $lesson->mediaVideo->type != 'embed'): ?>
            ...
            duration = 10; // Set a default duration
            ...
            // Set interval for updating progress every 3 seconds
...
<?php echo $__env->make('frontend.layouts.app'.config('theme_layout'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\language\resources\views/frontend/courses/lesson.blade.php ENDPATH**/ ?>