                ...
                <div class="col-md-9">
                    <div class="blog-details-content">
                        ...
                        <div class="blog-share-tag">
                            <div class="share-text float-left">
                                <?php echo app('translator')->get('labels.frontend.blog.share_this_news'); ?>
                            </div>
                    ...
                    <div class="blog-recent-post about-teacher-2">
                        <div class="section-title-2  headline text-left">
                            <h2> <?php echo app('translator')->get('labels.frontend.blog.related_news'); ?></h2>
                        </div>
                    ...
                    <div class="blog-comment-area ul-li about-teacher-2">
                        <div class="reply-comment-box">
                            <div class="section-title-2  headline text-left">
                                <h2> <?php echo app('translator')->get('labels.frontend.blog.post_comments'); ?></h2>
                            </div>
                                ...
                                <div class="teacher-faq-form">
                                    <form method="POST" action="<?php echo e(route('blogs.comment',['id'=>$blog->id])); ?>"
                                        ...
                                        <div class="form-group">
                                            <label for="comment"> <?php echo app('translator')->get('labels.frontend.blog.write_a_comment'); ?></label>
                                        ...
                                        <div class="nws-button text-center  gradient-bg text-uppercase">
                                            <button type="submit" value="Submit"> <?php echo app('translator')->get('labels.frontend.blog.add_comment'); ?></button>
                                        </div>
                                    </form>
                                </div>
                            <?php else: ?>
                                <a id="openLoginModal" class="btn nws-button gradient-bg text-white"
                                   data-target="#myModal"> <?php echo app('translator')->get('labels.frontend.blog.login_to_post_comment'); ?></a>
                            <?php endif; ?>
                        </div>
                                ...
                                <li class="d-block">
                                    ...
                                    <div class="author-name-rate">
                                        <div class="author-name float-left">
                                            <?php echo app('translator')->get('labels.frontend.blog.by'); ?>: <span><?php echo e($item->name); ?></span>
                                        </div>
                                        ...
                                        <div class="time-comment float-right">
                                            ...
                                            <a class="text-danger font-weight-bolf" href="<?php echo e(route('blogs.comment.delete',['id'=>$item->id])); ?>"> <?php echo app('translator')->get('labels.general.delete'); ?></a>
                        ...
                        <?php else: ?>
                            <p class="my-5"><?php echo app('translator')->get('labels.frontend.blog.no_comments_yet'); ?></p>
                        <?php endif; ?>
...
<?php echo $__env->make('frontend.layouts.app'.config('theme_layout'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\language\resources\views/frontend/blogs/blog-single.blade.php ENDPATH**/ ?>