            ...
            <div class="checkout-content">
                ...
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <?php if(count($courses) > 0): ?>
                            <?php if(
                                (config('services.stripe.active') == 0) && 
                            ...
                            <?php else: ?>
                                <div class="order-payment">
                                    ...
                                    <div id="accordion">
                                        <?php if(config('services.stripe.active', 0) == 1): ?>
                                                            ...
                                                            <div class="method-header-text">
                                                                <div class="radio">
                                                                    <label>
                                                                        ...
                                                                        type="radio" name="paymentMethod" value="1" checked>
                                                ...
                                                <div class="check-out-form collapse show" id="collapsePaymentOne" data-parent="#accordion">
                                                    ...
                                                    <form accept-charset="UTF-8"
                                                        ...
                                                        <div class="payment-info">
                                                            <label class=" control-label"><?php echo app('translator')->get('labels.frontend.cart.name_on_card'); ?>:</label>
                                                        ...
                                                        <button type="submit" class="text-white genius-btn mt25 gradient-bg text-center text-uppercase  bold-font">
                                                            <?php echo app('translator')->get('labels.frontend.cart.pay_now'); ?> 
                                            ...
                                            <div class="payment-method w-100 mb-0">
                                                ...
                                                <div class="check-out-form collapse disabled" id="collapsePaymentTwo"
                                                    ...
                                                    <form class="w3-container w3-display-middle w3-card-4 "
                                                          method="POST"
                                                          id="payment-form" 
                                                          action="<?php echo e(route('cart.paypal.payment')); ?>">
                                            ...
                                            <div class="payment-method w-100 mb-0">
                                                <div class="payment-method-header">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="payment-img float-right">
                                                                <img src="<?php echo e(asset('assets/img/banner/p-3.png')); ?>" alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="sub-total-item">
                                ...
                                <?php else: ?>
                                    <div class="purchase-list mt15 ul-li-block">
                                        <div class="in-total text-uppercase"><?php echo app('translator')->get('labels.frontend.cart.total'); ?> 
                                            <span><?php echo e($appCurrency['symbol']); ?>0.00</span>
                                        </div>
                                    </div>
                                <?php endif; ?>
                            </div>
...
<?php echo $__env->make('frontend.layouts.app'.config('theme_layout'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\language\resources\views/frontend/cart/checkout.blade.php ENDPATH**/ ?>