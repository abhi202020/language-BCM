<!-- this file is whats rendered in the menu-manager -->
                    ...
                    <div id="wpbody-content">
                        <div class="wrap">
                            ...
                            <div id="nav-menus-frame" class="row">
                                <!-- custom link / pages (right side of page) -->
                                                        ...
                                                        <div id="pages" class="collapse show" aria-labelledby="pages"
                                                                        ...
                                                                        <?php if($pages->count() > 0): ?>
                                                                            <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <div class="checkbox"
                                                                                    ...
                                                                                    <?php echo e(html()->label(html()->checkbox('category[]')->value($item->id)->class('page-checkbox').' &nbsp;'.$item->title)); ?>
                                                            ...
                                                            <div class="d-inline-block w-100 action-wrapper border-top col-12 pt-2 pb-1">
                                                                <div class="checkbox float-left">
                                                                    <?php echo e(html()->label(html()->checkbox()->class('select_all page-checkbox').' &nbsp; '. __('strings.backend.menu_manager.select_all') )->class('my-2')); ?>

                                                                </div>
                                                                <button type="button" class="btn btn-light add-to-menu border float-right">
...
<?php $__env->startPush('after-scripts'); ?>
    ...
    var idmenuValue = 1;
    console.log("idmenuValue:", idmenuValue);
    ...
    if (checked.length > 0) {
        $(checked).each(function () {
            ...
            value = $(this).val();
            label = $(this).parent('label').text().trim(); // Keep this line

            console.log("Item Type:", type);
            console.log("Item Value:", value);
            console.log("Item Label:", label);
            console.log("Item Link:", link);
            console.log("Final idmenu value:", $("#idmenu")[0].value);
            ...
            data.push({
                ...
                item_id: 1,
                idmenu: value,
                type: type  // Include the 'type' in the data array
            });
        });

        console.log("Data Array:", data);
        console.log("Final idmenu value:", $("#idmenu").val());

        $.ajax({
            data: { data: data, idmenu: $("#idmenu").val() },
...
<?php $__env->stopPush(); ?><?php /**PATH /home/customer/www/uat.margiesmagicalverbs.com/public_html/resources/views/vendor/wmenu/menu-html.blade.php ENDPATH**/ ?>