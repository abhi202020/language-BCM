            ...
            <div class="container">
                <div class="navbar-default d-inline-block w-100">
                    <div class="navbar-header float-left">
                        <a class="navbar-brand text-uppercase" href="<?php echo e(url('/')); ?>"><img
                                    src="<?php echo e(asset("storage/logos/".config('logo_white_image'))); ?>" alt="logo"></a>
                    </div><!-- /.navbar-header -->
                                ...
                                <li>
                                    <div class="mail-phone">
                                        ...
                                        <div class="info-content">
                                            <span class="info-id"><?php echo e($contact_data["primary_email"]["value"]); ?></span>
                                            <span class="info-text">
                                                <?php echo app('translator')->get('labels.frontend.layouts.partials.email_registration'); ?>
                                            </span>
                                        </div>
                                    </div>
                                </li>
                            ...
                            <?php if($contact_data["primary_phone"]["status"] == 1): ?>
                                <li>
                                    <div class="mail-phone">
                                        ...
                                        <div class="info-content">
                                            <span class="info-id"><?php echo e($contact_data["primary_phone"]["value"]); ?></span>
                                            <span class="info-text">
                                                <?php echo app('translator')->get('labels.frontend.layouts.partials.call_us_registration'); ?>
                                            </span>
                                        </div>
                                    </div>
                                </li>
                    ...
                    <div class="row">
                        ...
                        <div class="logo-area">
                            <a href="<?php echo e(url('/')); ?>">
                                <img src="<?php echo e(asset("storage/logos/".config('logo_w_image'))); ?>" alt="Logo_not_found">
                            </a>
                        </div>
                        ...
                        <?php $__currentLoopData = $custom_menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($menu['id'] == $menu['parent']): ?>
                                <?php if(count($menu->subs) == 0): ?>
                                    <li class="card">
                                        <a href="<?php echo e(asset($menu->link)); ?>"
                                           class="menu-link <?php echo e(active_class(Active::checkRoute('frontend.user.dashboard'))); ?>"
                                           id="menu-<?php echo e($menu->id); ?>"><?php echo e(trans('custom-menu.'.$menu_name.'.'.str_slug($menu->label))); ?></a>
                                    </li>
                                <?php else: ?>
                                    <li class="card">
                                        <div class="card-header" id="heading<?php echo e($menu->id); ?>">
                                            <button class="menu-link" data-toggle="collapse"
                                                    data-target="#collapse<?php echo e($menu->id); ?>"
                                                    aria-expanded="true" aria-controls="collapse<?php echo e($menu->id); ?>">
                                                <?php echo e(trans('custom-menu.'.$menu_name.'.'.str_slug($menu->label))); ?>

                                            </button>
                                        </div>
                                        <ul id="collapse<?php echo e($menu->id); ?>" class="submenu collapse "
                                            aria-labelledby="heading<?php echo e($menu->id); ?>"
                            ...
                            <li class="card">
                                <div class="card-header" id="headingLang">
                                    <button class="menu-link" data-toggle="collapse"
                                        ...
                                        <?php echo app('translator')->get('menus.language-picker.language'); ?>
...
<?php /**PATH C:\xampp\htdocs\language\resources\views\frontend\layouts\app4.blade.php ENDPATH**/ ?>