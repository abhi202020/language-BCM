...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo Form::model($faq, ['method' => 'PUT', 'route' => ['admin.faqs.update', $faq->id], 'files' => true,]); ?>


    <div class="card">
        <div class="card-header">
            <h3 class="page-title float-left mb-0"><?php echo app('translator')->get('labels.backend.faqs.edit'); ?></h3>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12 form-group">
                    ...
                    <?php echo Form::select('category', $category,  $faq->category_id, ['class' => 'form-control select2']); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\language\resources\views\backend\faqs\edit.blade.php ENDPATH**/ ?>