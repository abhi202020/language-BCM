                        ...
                        <table id="myTable" class="table table-bordered table-striped">
                            ...
                            <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($item->updated_at->format('Y-m-d\TH:i')); ?></td>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                        <a target="_blank" href="<?php echo e(route('admin.invoices.view', ['code' => $item->id])); ?>" class="btn mb-1 btn-danger">
                                            <?php echo app('translator')->get('labels.backend.invoices.fields.view'); ?>
                                        </a>

                                        <!-- <a href="<?php echo e(route('admin.invoice.download',['order'=>$order_id])); ?>" class="btn mb-1 btn-success">
                                            <?php echo app('translator')->get('labels.backend.invoices.fields.download'); ?>
                                        </a> -->

                                        <!-- Access additional invoice information -->
                                        <?php echo e($item->pdf_reference_uuid); ?>

                                        <!-- <?php echo e($item->user_id); ?> -->
                                        <?php echo e($item->price); ?>

                                        <?php echo e($item->course_id); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\language\resources\views/backend/invoices/index.blade.php ENDPATH**/ ?>