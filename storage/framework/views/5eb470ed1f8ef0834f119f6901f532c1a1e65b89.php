...
<?php $__env->startSection('title', __('labels.backend.general_settings.footer.title').' | '.app_name()); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-sm-5">
                    <h3 class="page-title d-inline"><?php echo app('translator')->get('labels.backend.general_settings.footer.title'); ?></h3>
                </div>
            </div>
        </div>
        ...
        <div class="card-body" id="footer">
            ...
            <div class="form-group row">
                <?php echo e(html()->label(__('labels.backend.general_settings.footer.short_description'))->class('col-md-2 form-control-label')->for('short_description')); ?>

                <div class="col-md-8">
                    <?php echo e(html()->textarea()
                ...
                <div class="col-md-2">
                    <p style="line-height: 35px">
                        <span class="mr-2"><?php echo e(__('labels.backend.general_settings.contact.show')); ?></span> <?php echo e(html()->label(html()->checkbox('')
                                        ->checked()->class('switch-input status')->value(1)->checked()
                                  . '<span class="switch-label"></span><span class="switch-handle"></span>')
                              ->class('switch switch-sm switch-3d switch-primary')); ?> </p>
                </div>
            </div>
            <?php for($i=1; $i<=3; $i++): ?>
                <div class="form-group row" style="visibility: hidden; height: 1px">
                    <?php echo e(html()->label(__('labels.backend.general_settings.footer.section_'.$i))->class('col-md-2 form-control-label')->for('section'.$i)); ?>

                    <div class="col-md-8 options">
                        <div class="row">
                            <div class="col-4">
                                <?php echo e(html()->label(html()->radio('section'.$i)
                          ->checked()->class('switch-input section'.$i)->value(1)->checked()
                    . '<span class="switch-label"></span><span class="switch-handle"></span>')
                ->class('switch switch-sm switch-3d switch-success')); ?>

                                <span class="ml-2 title"><?php echo e(__('labels.backend.general_settings.footer.popular_categories')); ?></span>
                            </div>
                 ...
                 ->class('switch switch-sm switch-3d switch-success')); ?>
                                ...
                                <span class="ml-2 title"><?php echo e(__('labels.backend.general_settings.footer.featured_courses')); ?></span>
                            </div>
               ...
               ->class('switch switch-sm switch-3d switch-success')); ?>
                                ...
                                <span class="ml-2 title"><?php echo e(__('labels.backend.general_settings.footer.trending_courses')); ?></span>
                ...
                ->class('switch switch-sm switch-3d switch-success')); ?>
                                ...
                                <span class="ml-2 title"><?php echo e(__('labels.backend.general_settings.footer.popular_courses')); ?></span>
                            </div>
                ...
                ->class('switch switch-sm switch-3d switch-success')); ?>
                                ...
                                <span class="ml-2 title"><?php echo e(__('labels.backend.general_settings.footer.custom_links')); ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
            ...
            <div class="form-group row">
                <?php echo e(html()->label(__('labels.backend.general_settings.footer.social_links'))->class('col-md-2 form-control-label')->for('social_links')); ?>


                <div class="col-md-4">
                    <?php echo e(html()->text('')
                        ->id('social_link_url')
                        ->class('form-control')
                ...
                <div class="col-md-2">
                    <button type="button"
                            class="btn btn-block btn-light add-social-link border"><?php echo e(trans('strings.backend.general.app_add')); ?>
                ...
                <div class="col-md-10 offset-2">
                    <p class="font-italic"><?php echo __('labels.backend.general_settings.footer.social_links_note'); ?></p>
                </div>
            ...
            <div class="form-group row">
                <?php echo e(html()->label(__('labels.backend.general_settings.footer.newsletter_form'))->class('col-md-2 form-control-label')->for('newsletter_form')); ?>
            ...
            <div class="form-group row">
                <?php echo e(html()->label(__('labels.backend.general_settings.footer.bottom_footer'))->class('col-md-2 form-control-label')->for('newsletter_form')); ?>
                ...
                <div class="col-md-10">
                    <p style="line-height: 35px">
                        ...
                        <span class="ml-3 font-italic"><?php echo e(__('labels.backend.general_settings.footer.bottom_footer_note')); ?></span>
                    </p>
                </div>
            </div>

            <div class="form-group row">
                <?php echo e(html()->label(__('labels.backend.general_settings.footer.copyright_text'))->class('col-md-2 form-control-label')->for('copyright_text')); ?>
            ...
            <div class="form-group row">
                <?php echo e(html()->label(__('labels.backend.general_settings.footer.footer_links'))->class('col-md-2 form-control-label')->for('footer_links')); ?>
                ...
                <div class="col-md-2">
                    <button type="button"
                            class="btn btn-block btn-light add-footer-link border"><?php echo e(trans('strings.backend.general.app_add')); ?>
...
<?php $__env->startPush('after-scripts'); ?>
    ...
    <script>
        $(document).ready(function () {
            ...
            //========== Preset Footer Data ===========//
            <?php if(config('footer_data')): ?>
            var footer_data = "<?php echo e(config('footer_data')); ?>";
        ...
        $(document).on('click', '.options input', function () {
            ...
            if ($(this).is(':checked') && $(this).val() == 5) {
                ...
                if ($(button_container).find('.button-wrapper').length == 0) {
                    var name = "<?php echo e(__('labels.backend.general_settings.footer.link')); ?>";
                    var link_label = "<?php echo e(__('labels.backend.general_settings.footer.link_label')); ?>";
                    var link_url = "<?php echo e(__('labels.backend.general_settings.footer.link_url')); ?>";
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\language\resources\views/backend/settings/footer.blade.php ENDPATH**/ ?>