        ...
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <h3 class="page-title d-inline"><?php echo app('translator')->get('labels.backend.backup.title'); ?></h3>
                </div><!--card-header-->
                <div class="card-body">
                    ...
                    <div class="col">
                        <div class="form-group row">
                            <h4 class="text-center text-danger"><?php echo app('translator')->get('labels.backend.backup.backup_notice'); ?></h4>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <p class="">
                                        ...
                                        <span class="text-muted float-right"><?php echo app('translator')->get('labels.backend.backup.dropbox_note'); ?></span>
                                    </p>
                                </div>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\language\resources\views\backend\backup\index.blade.php ENDPATH**/ ?>