        ...
        <div class="container">
            <div class="page-breadcrumb-content text-center">
                <div class="page-breadcrumb-title">
                    <h2 class="breadcrumb-head black bold">  <?php echo e(($q) ? ".$q." : ''); ?> <span><?php echo e(trans('labels.frontend.course.bundles')); ?></span></h2>
                </div>
            </div>
        </div>
    </section>
                                                    ...
                                                    <div class="best-course-pic-text relative-position">
                                                        <div class="best-course-pic relative-position"
                                                            ...
                                                            <div class="course-details-btn">
                                                                <a class="text-uppercase"
                                                                   href="<?php echo e(route('courses.show', [$bundle->slug])); ?>"><?php echo app('translator')->get('labels.frontend.search_result.course_detail'); ?>
                                                        ...
                                                        <div class="best-course-text">
                                                            <div class="course-title mb20 headline relative-position">
                                                                <h3>
                                                                    <a href="<?php echo e(route('courses.show', [$bundle->slug])); ?>"><?php echo e($bundle->title); ?></a>
                                                                </h3>
                                                            </div>
                                                        ...
                                                        <div class="course-list-img-text">
                                                            ...
                                                            <div class="course-list-text">
                                                                ...
                                                                <span class="course-category bold-font"><a
                                                                            href="<?php echo e(route('courses.show', [$bundle->slug])); ?>"><?php if($bundle->free == 1): ?>
...
<?php echo $__env->make('frontend.layouts.app'.config('theme_layout'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\language\resources\views\frontend\search-result\bundles.blade.php ENDPATH**/ ?>