        ...
        <div class="container">
            <div class="page-breadcrumb-content text-center">
                <div class="page-breadcrumb-title">
                    <h2 class="breadcrumb-head black bold"><span> <?php echo app('translator')->get('labels.frontend.contact.title'); ?></span></h2>
                </div>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('frontend.layouts.app'.config('theme_layout'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/uat.margiesmagicalverbs.com/public_html/resources/views/frontend/contact.blade.php ENDPATH**/ ?>