...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-3 ml-auto">
                    <div class="card text-white bg-danger text-center">
                        <div class="card-body">
                            <h2 class=""><?php echo e($subscribe_sales); ?></h2>
                            <h5><?php echo app('translator')->get('labels.backend.reports.total_subscribe'); ?></h5>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-3 ml-auto">
                    <div class="card text-white bg-dark text-center">
                        <div class="card-body">
                            <h2 class=""><?php echo e($appCurrency['symbol'].' '.$subscribe_earnings); ?></h2>
                            <h5><?php echo app('translator')->get('labels.backend.reports.subscribe_earning'); ?></h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <h4><?php echo app('translator')->get('labels.backend.reports.subscribed_plan'); ?></h4>
                    <div class="table-responsive">
                        <table id="mySubscribeTable" class="table table-bordered table-striped ">
                            ...
                            <tr>
                                ...
                                <th><?php echo app('translator')->get('labels.general.id'); ?></th>
                                <th><?php echo app('translator')->get('labels.backend.reports.fields.student'); ?></th>
                                <th><?php echo app('translator')->get('labels.backend.reports.fields.subscribed_name'); ?></th>
                                <th><?php echo app('translator')->get('labels.backend.reports.fields.amount'); ?> <span style="font-weight: lighter">(in <?php echo e($appCurrency['symbol']); ?>)</span></th>
                                <th><?php echo app('translator')->get('labels.backend.reports.fields.date'); ?></th>
                            </tr>
                            </thead>
...
<?php $__env->startPush('after-scripts'); ?>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var subscribe_route = '<?php echo e(route('admin.reports.get_subscribe_data')); ?>?'+queryParams;
        ...
        $('#date').daterangepicker({
            ...
            console.log('New date range selected: ' + start.format('Y-m-d\TH:i') + ' to ' + end.format('Y-m-d\TH:i') + ' (predefined range: ' + label + ')');
        });
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\language\resources\views\backend\reasons\reports\sales.blade.php ENDPATH**/ ?>